...
$(document).ready(function(){
	...
	$("#Proviance").change(function(){
		...
		$.ajax({
			  url: "map/getDataFilter.php",//ที่อยู่ของไฟล์เป้าหมาย
			  global: false,
			  ...
			  success: function(jd) { //แสดงข้อมูลเมื่อทำงานเสร็จ โดยใช้ each ของ jQuery
                            ...
                            $("#namePlace").val($("#Proviance option:selected").text());
	...
	$("#District").change(function(){
		...
		$.ajax({
			  ...
			  success: function(jd) {
							...
							var ProviceSelected = $("#Proviance option:selected").text();
							var DistrictSelected = $("#District option:selected").text();

							$("#namePlace").val(ProviceSelected + " " + DistrictSelected);
	...
	$("#Subdistrict").change(function(){
		...
		$.ajax({
			  ...
			  success: function(jd) {
							...
							var ProviceSelected = $("#Proviance option:selected").text();
							var DistrictSelected = $("#District option:selected").text();
							var SubdistrictSelected = $("#Subdistrict option:selected").text();

							$("#namePlace").val(ProviceSelected + " " + DistrictSelected + " " + SubdistrictSelected);
