...
<!--                             <tr>
                        ...
                        <div class="hide" id="hide">
                                ...
                                <div id="map_canvas"></div>     
                                        <input type="hidden" name="lat_value" type="text" id="lat_value"  />  <br /><input type="hidden" name="lon_value" type="text" id="lon_value"  />  <br />
                                        <a href="index.html"><button type="button" id="btnBack">กลับไปหน้าหลัก</button></a>
                                        <button type="button" id="btnSubmit">บันทึก</button> 
                        </div>
				</div>
			</div>
